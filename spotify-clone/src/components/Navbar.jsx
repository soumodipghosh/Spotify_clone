  ...
  return (
    ...
    <div className='w-full flex justify-between items-center font-semibold'>
        ...
        <div className='flex items-center gap-4' >
            <p className='bg-white text-black text-[15px] px-4 py-1 
            rounded hidden md:block cursor-pointer'>Explore Premium</p>
    ...
    <div className='flex items-center gap-2 mt-4' >
        ...
        <p className='bg-black py-1 px-4 rounded cursor-pointer' >Music</p>
        <p className='bg-black py-1 px-4 rounded cursor-pointer' >Podcasts</p>
    </div>
    </>
  )
}
